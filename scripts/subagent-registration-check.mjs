...
export async function verifySubagentRegistration(source) {
 ...
 const factory=new Function('BK','Roe','Xr','Zs','Xe','vt','$Be','O7e','__ensureChatgptTaskBubble','__ensureClaudeTaskBubble','return ({'+method+'})._waitForParentTaskBubbleIfPossible');
